...
// ========== Maven 发布（供其他项目依赖）==========
// 发布到本地：./gradlew :sdk:publishToMavenLocal
// 其他项目：repositories { mavenLocal(); ... } 然后 implementation("com.netonstream.privchat:sdk:0.1.0")
// artifactId 由 Gradle/KMP 按各平台自动生成，不要统一覆盖为同一 id
publishing {
    publications.withType<MavenPublication>().configureEach {
        groupId = "com.netonstream.privchat"
