...
interface PrivchatClientInterface {
     ...
     */
        @Throws(PrivchatFfiException::class,kotlin.coroutines.cancellation.CancellationException::class)suspend fun `ensureMessageThumbnail`(`messageId`: kotlin.ULong)
     ...
     */
        @Throws(PrivchatFfiException::class,kotlin.coroutines.cancellation.CancellationException::class)suspend fun `persistUserProfileLocal`(`targetUserId`: kotlin.ULong, `channelId`: kotlin.ULong)
...
expect open class PrivchatClient: Disposable, PrivchatClientInterface {
    ...
    @Throws(PrivchatFfiException::class,kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `ensureMessageThumbnail`(`messageId`: kotlin.ULong)
    ...
    @Throws(PrivchatFfiException::class,kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `persistUserProfileLocal`(`targetUserId`: kotlin.ULong, `channelId`: kotlin.ULong)
...
data class StoredChannel (
     ...
     */
    var `peerAvatarUrl`: kotlin.String?
         = null 
) {
...
sealed class SdkEvent {
    ...
    data class OutboundQueueUpdated(
        ...
        val `messageId`: kotlin.ULong?  = null  ) : SdkEvent() {
