...
interface PrivchatClientInterface {
    ...
    suspend fun `acceptFriendRequest`(`fromUserId`: kotlin.ULong, `message`: kotlin.String?): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `accountUserDetailRemote`(`userId`: kotlin.ULong): AccountUserDetailView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `accountUserShareCardRemote`(`userId`: kotlin.ULong): AccountUserShareCardView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `accountUserUpdateRemote`(`payload`: AccountUserUpdateInput): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `ackOutboundFiles`(`queueIndex`: kotlin.ULong, `messageIds`: List<kotlin.ULong>): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `ackOutboundMessages`(`messageIds`: List<kotlin.ULong>): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `addChannelMembers`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `memberUids`: List<kotlin.ULong>
    )

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `addReaction`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong?,
        `emoji`: kotlin.String
    ): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `addReactionBlocking`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong?,
        `emoji`: kotlin.String
    ): kotlin.Boolean

    @Throws(PrivchatFfiException::class)
    fun `addServer`(`endpoint`: ServerEndpoint)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `addToBlacklist`(`blockedUserId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `assetsDir`(): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `authLogoutRemote`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `authRefreshRemote`(`payload`: AuthRefreshInput): LoginResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `authenticate`(`userId`: kotlin.ULong, `token`: kotlin.String, `deviceId`: kotlin.String)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `batchGetPresence`(`userIds`: List<kotlin.ULong>): List<PresenceStatus>
    fun `build`(): kotlin.String
    fun `builder`(): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelBroadcastCreateRemote`(`payload`: ChannelBroadcastCreateInput): ChannelBroadcastCreateView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelBroadcastListRemote`(`payload`: ChannelBroadcastListInput): ChannelBroadcastListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelBroadcastSubscribeRemote`(`payload`: ChannelBroadcastSubscribeInput): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelContentListRemote`(`payload`: ChannelContentListInput): ChannelContentListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelContentPublishRemote`(`payload`: ChannelContentPublishInput): ChannelContentPublishView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelNotificationMode`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): kotlin.Int

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelSendQueueSetEnabled`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelTags`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): List<kotlin.String>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `channelUnreadStats`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): kotlin.Int

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `checkBlacklist`(`targetUserId`: kotlin.ULong): BlacklistCheckResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `checkFriend`(`friendId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `clearLocalState`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `clearPresenceCache`()
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `connectBlocking`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `connectionState`(): ConnectionState
    ...
    suspend fun `createGroup`(
        ...
        `memberIds`: List<kotlin.ULong>?
    ): GroupCreateResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `createLocalMessage`(`input`: NewMessage): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `dataDir`(): kotlin.String
    fun `debugMode`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `deleteBlacklistEntry`(`blockedUserId`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `deleteChannelMember`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `memberUid`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `deleteFriend`(`friendId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `disconnect`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `dmPeerUserId`(`channelId`: kotlin.ULong): kotlin.ULong?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `downloadAttachmentToCache`(`sourcePath`: kotlin.String, `fileName`: kotlin.String): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `downloadAttachmentToMessageDir`(
        `sourcePath`: kotlin.String,
        `messageId`: kotlin.ULong,
        `fileName`: kotlin.String
    ): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `downloadAttachmentToPath`(`sourcePath`: kotlin.String, `targetPath`: kotlin.String): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `editMessage`(`messageId`: kotlin.ULong, `content`: kotlin.String, `editedAt`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `editMessageBlocking`(`messageId`: kotlin.ULong, `content`: kotlin.String, `editedAt`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `enqueueLocalMessage`(`input`: NewMessage): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `enqueueOutboundFile`(
        `messageId`: kotlin.ULong,
        `routeKey`: kotlin.String,
        `payload`: kotlin.ByteArray
    ): FileQueueRef

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `enqueueOutboundMessage`(`messageId`: kotlin.ULong, `payload`: kotlin.ByteArray): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `enqueueText`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `fromUid`: kotlin.ULong,
        `content`: kotlin.String
    ): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `enqueueTextWithLocalId`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `fromUid`: kotlin.ULong,
        `content`: kotlin.String,
        `localMessageId`: kotlin.ULong?
    ): kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `entitySyncRemote`(`payload`: SyncEntitiesInput): SyncEntitiesView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `fetchGroupMembersRemote`(
        `groupId`: kotlin.ULong,
        `page`: kotlin.UInt?,
        `pageSize`: kotlin.UInt?
    ): GroupMemberRemoteList

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `fetchPresence`(`userIds`: List<kotlin.ULong>): List<PresenceStatus>
    fun `fileApiBaseUrl`(): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `fileRequestUploadTokenRemote`(`payload`: FileRequestUploadTokenInput): FileRequestUploadTokenView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `fileUploadCallbackRemote`(`payload`: FileUploadCallbackInput): kotlin.Boolean

    @Throws(PrivchatFfiException::class)
    fun `generateLocalMessageId`(): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getAllUnreadMentionCounts`(`userId`: kotlin.ULong): List<UnreadMentionCount>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getBlacklist`(): List<StoredBlacklistEntry>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannelById`(`channelId`: kotlin.ULong): StoredChannel?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannelExtra`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): StoredChannelExtra?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannelListEntries`(`page`: kotlin.ULong, `pageSize`: kotlin.ULong): List<StoredChannel>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannelSyncState`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): ChannelSyncState

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannelUnreadCount`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): kotlin.Int

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getChannels`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredChannel>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getDevicePushStatus`(`deviceId`: kotlin.String?): DevicePushStatusView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getEarliestId`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): kotlin.ULong?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getFriendPendingRequests`(): List<FriendPendingEntry>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getFriends`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredFriend>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getGroupById`(`groupId`: kotlin.ULong): StoredGroup?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getGroupInfo`(`groupId`: kotlin.ULong): GroupInfoView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getGroups`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredGroup>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getMessageById`(`messageId`: kotlin.ULong): StoredMessage?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getMessageExtra`(`messageId`: kotlin.ULong): StoredMessageExtra?
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getMessagesRemote`(
        `channelId`: kotlin.ULong,
        `beforeServerMessageId`: kotlin.ULong?,
        `limit`: kotlin.UInt?
    ): MessageHistoryView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getOrCreateDirectChannel`(`peerUserId`: kotlin.ULong): DirectChannelResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getPresence`(`userId`: kotlin.ULong): PresenceStatus?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getPresenceStats`(): PresenceStatsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getPrivacySettings`(): PrivacySettingsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getProfile`(): ProfileView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getTotalUnreadCount`(`excludeMuted`: kotlin.Boolean): kotlin.Int

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getTypingStats`(): TypingStatsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getUnreadMentionCount`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `userId`: kotlin.ULong
    ): kotlin.Int
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `getUserById`(`userId`: kotlin.ULong): StoredUser?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupAddMembersRemote`(`groupId`: kotlin.ULong, `userIds`: List<kotlin.ULong>): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupApprovalHandleRemote`(
        `approvalId`: kotlin.ULong,
        `approved`: kotlin.Boolean,
        `reason`: kotlin.String?
    ): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupApprovalListRemote`(
        `groupId`: kotlin.ULong,
        `page`: kotlin.UInt?,
        `pageSize`: kotlin.UInt?
    ): GroupApprovalListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupGetSettingsRemote`(`groupId`: kotlin.ULong): GroupSettingsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupLeaveRemote`(`groupId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupMuteAllRemote`(`groupId`: kotlin.ULong, `enabled`: kotlin.Boolean): GroupMuteAllView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupMuteMemberRemote`(
        `groupId`: kotlin.ULong,
        `userId`: kotlin.ULong,
        `durationSeconds`: kotlin.ULong?
    ): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupQrcodeGenerateRemote`(
        `groupId`: kotlin.ULong,
        `expireSeconds`: kotlin.ULong?
    ): GroupQrCodeGenerateView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupQrcodeJoinRemote`(`qrKey`: kotlin.String, `token`: kotlin.String?): GroupQrCodeJoinResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupRemoveMemberRemote`(`groupId`: kotlin.ULong, `userId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupSetRoleRemote`(
        `groupId`: kotlin.ULong,
        `userId`: kotlin.ULong,
        `role`: kotlin.String
    ): GroupRoleSetView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupTransferOwnerRemote`(
        `groupId`: kotlin.ULong,
        `targetUserId`: kotlin.ULong
    ): GroupTransferOwnerView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupUnmuteMemberRemote`(`groupId`: kotlin.ULong, `userId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `groupUpdateSettingsRemote`(`payload`: GroupSettingsUpdateInput): kotlin.Boolean
    fun `heartbeatInterval`(): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `hideChannel`(`channelId`: kotlin.ULong): kotlin.Boolean
    fun `httpClientConfig`(): HttpClientConfigView
    fun `imageSendMaxEdge`(): kotlin.UInt

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `inviteToGroup`(`groupId`: kotlin.ULong, `memberIds`: List<kotlin.ULong>): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `isBootstrapCompleted`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `isConnected`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `isEventReadBy`(`serverMessageId`: kotlin.ULong, `userId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `isInitialized`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `isShuttingDown`(): kotlin.Boolean
    fun `isSupervisedSyncRunning`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `joinGroupByQrcode`(`qrKey`: kotlin.String): GroupQrCodeJoinResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `leaveChannel`(`channelId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `leaveGroup`(`groupId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listBlacklistEntries`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredBlacklistEntry>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listChannelMembers`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredChannelMember>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listChannels`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredChannel>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listFriends`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredFriend>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listGroups`(`limit`: kotlin.ULong, `offset`: kotlin.ULong): List<StoredGroup>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listLocalAccounts`(): List<LocalAccountSummary>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listMessageReactions`(
        `messageId`: kotlin.ULong,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredMessageReaction>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listMyDevices`(): List<DeviceInfoView>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listPendingReminders`(
        `uid`: kotlin.ULong,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredReminder>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listReactions`(`serverMessageId`: kotlin.ULong): MessageReactionListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listUnreadMentionMessageIds`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `userId`: kotlin.ULong,
        `limit`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `listUsersByIds`(`userIds`: List<kotlin.ULong>): List<StoredUser>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `logConnectionState`(): ConnectionSummary

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `login`(`username`: kotlin.String, `password`: kotlin.String, `deviceId`: kotlin.String): LoginResult

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `logout`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markAllMentionsRead`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `userId`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markFullyReadAt`(`channelId`: kotlin.ULong, `readPts`: kotlin.ULong): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markMentionRead`(`messageId`: kotlin.ULong, `userId`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markMessageSent`(`messageId`: kotlin.ULong, `serverMessageId`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markReadToPts`(`channelId`: kotlin.ULong, `readPts`: kotlin.ULong): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markReadToPtsBlocking`(`channelId`: kotlin.ULong, `readPts`: kotlin.ULong): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `markReminderDone`(`reminderId`: kotlin.ULong, `done`: kotlin.Boolean)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `messageReadList`(`serverMessageId`: kotlin.ULong, `channelId`: kotlin.ULong): MessageReadListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `messageReadStats`(`serverMessageId`: kotlin.ULong, `channelId`: kotlin.ULong): MessageReadStatsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `messageUnreadCountRemote`(`channelId`: kotlin.ULong): MessageUnreadCountView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `muteChannel`(`channelId`: kotlin.ULong, `muted`: kotlin.Boolean): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `needsSync`(): kotlin.Boolean
    fun `networkEventsSince`(`sequenceId`: kotlin.ULong, `limit`: kotlin.ULong): List<SequencedSdkEvent>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextEvent`(`timeoutMs`: kotlin.ULong): SdkEvent?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextEventEnvelope`(`timeoutMs`: kotlin.ULong): SequencedSdkEvent?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextNetworkEvent`(`timeoutMs`: kotlin.ULong): SdkEvent?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextNetworkEventEnvelope`(`timeoutMs`: kotlin.ULong): SequencedSdkEvent?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextTimelineEvent`(`timeoutMs`: kotlin.ULong): SdkEvent?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `nextTimelineEventEnvelope`(`timeoutMs`: kotlin.ULong): SequencedSdkEvent?
    fun `onAppBackground`()
    fun `onAppForeground`()
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `ownLastRead`(`channelId`: kotlin.ULong): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `paginateBack`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `page`: kotlin.ULong,
        `pageSize`: kotlin.ULong
    ): List<StoredMessage>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `paginateForward`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `page`: kotlin.ULong,
        `pageSize`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `peekOutboundFiles`(`queueIndex`: kotlin.ULong, `limit`: kotlin.ULong): List<QueueMessage>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `peekOutboundMessages`(`limit`: kotlin.ULong): List<QueueMessage>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `pinChannel`(`channelId`: kotlin.ULong, `pinned`: kotlin.Boolean): kotlin.Boolean
    ...
    suspend fun `qrcodeGenerate`(
        `qrType`: kotlin.String,
        `payload`: kotlin.String,
        `expireSeconds`: kotlin.ULong?
    ): QrCodeGenerateView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `qrcodeList`(`includeRevoked`: kotlin.Boolean?): QrCodeListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `qrcodeRefresh`(`qrType`: kotlin.String, `targetId`: kotlin.String): QrCodeRefreshView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `qrcodeResolve`(`qrKey`: kotlin.String, `token`: kotlin.String?): QrCodeResolveView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `qrcodeRevoke`(`qrKey`: kotlin.String): QrCodeRevokeView
    fun `queueConfig`(): QueueConfigView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `reactionStats`(`serverMessageId`: kotlin.ULong): MessageReactionStatsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `reactions`(`serverMessageId`: kotlin.ULong): MessageReactionListView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `reactionsBatch`(`serverMessageIds`: List<kotlin.ULong>): ReactionsBatchView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `recallMessage`(`serverMessageId`: kotlin.ULong, `channelId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `recallMessageBlocking`(`serverMessageId`: kotlin.ULong, `channelId`: kotlin.ULong): kotlin.Boolean
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `recordMention`(`input`: MentionInput): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `register`(`username`: kotlin.String, `password`: kotlin.String, `deviceId`: kotlin.String): LoginResult
    fun `registerLifecycleHook`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `rejectFriendRequest`(`fromUserId`: kotlin.ULong, `message`: kotlin.String?): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `removeChannelMember`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `memberUid`: kotlin.ULong)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `removeFromBlacklist`(`blockedUserId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `removeGroupMember`(`groupId`: kotlin.ULong, `userId`: kotlin.ULong): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `removeReaction`(`serverMessageId`: kotlin.ULong, `emoji`: kotlin.String): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `removeVideoProcessHook`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `requireCurrentUserId`(): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `resolveChannelIdByServerMessageId`(`serverMessageId`: kotlin.ULong): kotlin.ULong
    suspend fun `resolveChannelType`(`channelId`: kotlin.ULong): kotlin.Int

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `resolveLocalMessageIdByServerMessageId`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `serverMessageId`: kotlin.ULong
    ): kotlin.ULong?
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `retryMessage`(`messageId`: kotlin.ULong): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `rpcCall`(`route`: kotlin.String, `bodyJson`: kotlin.String): kotlin.String

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `runBootstrapSync`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `searchChannel`(`keyword`: kotlin.String): List<StoredChannel>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `searchUserByQrcode`(`qrKey`: kotlin.String, `token`: kotlin.String?): AccountSearchResultView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `searchUsers`(`query`: kotlin.String): List<SearchUserEntry>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `seenByForEvent`(`serverMessageId`: kotlin.ULong): List<SeenByEntry>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `sendLocalMessageNow`(`input`: NewMessage): kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `sendMessageWithInput`(`input`: NewMessage): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `sendMessageWithOptions`(`input`: NewMessage, `options`: SendMessageOptionsInput): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `sendQueueSetEnabled`(`enabled`: kotlin.Boolean)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `sendTyping`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `isTyping`: kotlin.Boolean,
        `actionType`: TypingActionType
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setChannelFavourite`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `enabled`: kotlin.Boolean)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setChannelLowPriority`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `enabled`: kotlin.Boolean)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setChannelNotificationMode`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int, `mode`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setCurrentUid`(`uid`: kotlin.String)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setMessagePinned`(`messageId`: kotlin.ULong, `isPinned`: kotlin.Boolean)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setMessageRevoke`(`messageId`: kotlin.ULong, `revoked`: kotlin.Boolean, `revoker`: kotlin.ULong?)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setNetworkHint`(`hint`: NetworkHint)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `setVideoProcessHook`(`hook`: VideoProcessHook?)
    ...
    @Throws(PrivchatFfiException::class)
    fun `startSupervisedSync`(`intervalSecs`: kotlin.ULong)
    fun `startTransportDisconnectListener`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `startTyping`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `startTypingBlocking`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `stickerPackageDetailRemote`(`payload`: StickerPackageDetailInput): StickerPackageDetailView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `stickerPackageListRemote`(`payload`: StickerPackageListInput): StickerPackageListView
    fun `stopSupervisedSync`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `stopTyping`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `storage`(): UserStoragePaths
     ...
     */
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `subscribeChannel`(`channelId`: kotlin.ULong, `channelType`: kotlin.UByte, `token`: kotlin.String?)
    fun `subscribeEvents`(): kotlin.Boolean
    fun `subscribeNetworkStatus`(): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `subscribePresence`(`userIds`: List<kotlin.ULong>): List<PresenceStatus>

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncAllChannels`(): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncBatchGetChannelPtsRemote`(`payload`: BatchGetChannelPtsInput): BatchGetChannelPtsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncChannel`(`channelId`: kotlin.ULong, `channelType`: kotlin.Int): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncEntities`(`entityType`: kotlin.String, `scope`: kotlin.String?): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncEntitiesInBackground`(`entityType`: kotlin.String, `scope`: kotlin.String?)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncGetChannelPtsRemote`(`payload`: GetChannelPtsInput): ChannelPtsView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncGetDifferenceRemote`(`payload`: GetDifferenceInput): GetDifferenceView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncMessages`(): kotlin.ULong

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncMessagesInBackground`()

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `syncSubmitRemote`(`payload`: SyncSubmitInput): SyncSubmitView
     ...
     */
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `unsubscribeChannel`(`channelId`: kotlin.ULong, `channelType`: kotlin.UByte)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `unsubscribePresence`(`userIds`: List<kotlin.ULong>)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `updateDevicePushState`(
        `deviceId`: kotlin.String,
        `apnsArmed`: kotlin.Boolean,
        `pushToken`: kotlin.String?
    ): DevicePushUpdateView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `updateMessageStatus`(`messageId`: kotlin.ULong, `status`: kotlin.Int)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `updatePrivacySettings`(`payload`: AccountPrivacyUpdateInput): kotlin.Boolean

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `updateProfile`(`payload`: ProfileUpdateInput): ProfileView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertBlacklistEntry`(`input`: UpsertBlacklistInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertChannel`(`input`: UpsertChannelInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertChannelExtra`(`input`: UpsertChannelExtraInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertChannelMember`(`input`: UpsertChannelMemberInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertFriend`(`input`: UpsertFriendInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertGroup`(`input`: UpsertGroupInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertGroupMember`(`input`: UpsertGroupMemberInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertMessageReaction`(`input`: UpsertMessageReactionInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertReminder`(`input`: UpsertReminderInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `upsertUser`(`input`: UpsertUserInput)

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `userId`(): kotlin.ULong?

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `userQrcodeGenerate`(`expireSeconds`: kotlin.ULong?): UserQrCodeGenerateView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `userQrcodeGet`(): UserQrCodeGetView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `userQrcodeRefresh`(): QrCodeRefreshView

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `userStoragePaths`(): UserStoragePaths

    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    suspend fun `wipeCurrentUserFull`()
...
expect open class PrivchatClient : Disposable, PrivchatClientInterface {
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `addChannelMembers`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `memberUids`: List<kotlin.ULong>
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `addReactionBlocking`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong?,
        `emoji`: kotlin.String
    ): kotlin.Boolean
    ...
    @Throws(PrivchatFfiException::class)
    override fun `addServer`(`endpoint`: ServerEndpoint)
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `channelSendQueueSetEnabled`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `enabled`: kotlin.Boolean
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `deleteChannelMember`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `memberUid`: kotlin.ULong
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `downloadAttachmentToMessageDir`(
        `sourcePath`: kotlin.String,
        `messageId`: kotlin.ULong,
        `fileName`: kotlin.String
    ): kotlin.String
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `editMessageBlocking`(
        `messageId`: kotlin.ULong,
        `content`: kotlin.String,
        `editedAt`: kotlin.Int
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `enqueueOutboundFile`(
        `messageId`: kotlin.ULong,
        `routeKey`: kotlin.String,
        `payload`: kotlin.ByteArray
    ): FileQueueRef
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `enqueueText`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `fromUid`: kotlin.ULong,
        `content`: kotlin.String
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `enqueueTextWithLocalId`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `fromUid`: kotlin.ULong,
        `content`: kotlin.String,
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `fetchGroupMembersRemote`(
        `groupId`: kotlin.ULong,
        `page`: kotlin.UInt?,
        `pageSize`: kotlin.UInt?
    ): GroupMemberRemoteList
    ...
    @Throws(PrivchatFfiException::class)
    override fun `generateLocalMessageId`(): kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `getMessagesRemote`(
        `channelId`: kotlin.ULong,
        `beforeServerMessageId`: kotlin.ULong?,
        `limit`: kotlin.UInt?
    ): MessageHistoryView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `getUnreadMentionCount`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `userId`: kotlin.ULong
    ): kotlin.Int
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupApprovalHandleRemote`(
        `approvalId`: kotlin.ULong,
        `approved`: kotlin.Boolean,
        `reason`: kotlin.String?
    ): kotlin.Boolean
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupApprovalListRemote`(
        `groupId`: kotlin.ULong,
        `page`: kotlin.UInt?,
        `pageSize`: kotlin.UInt?
    ): GroupApprovalListView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupMuteMemberRemote`(
        `groupId`: kotlin.ULong,
        `userId`: kotlin.ULong,
        `durationSeconds`: kotlin.ULong?
    ): kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupQrcodeGenerateRemote`(
        `groupId`: kotlin.ULong,
        `expireSeconds`: kotlin.ULong?
    ): GroupQrCodeGenerateView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupSetRoleRemote`(
        `groupId`: kotlin.ULong,
        `userId`: kotlin.ULong,
        `role`: kotlin.String
    ): GroupRoleSetView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `groupTransferOwnerRemote`(
        `groupId`: kotlin.ULong,
        `targetUserId`: kotlin.ULong
    ): GroupTransferOwnerView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `listBlacklistEntries`(
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredBlacklistEntry>


    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `listChannelMembers`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `listMessageReactions`(
        `messageId`: kotlin.ULong,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredMessageReaction>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `listPendingReminders`(
        `uid`: kotlin.ULong,
        `limit`: kotlin.ULong,
        `offset`: kotlin.ULong
    ): List<StoredReminder>
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `listUnreadMentionMessageIds`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `userId`: kotlin.ULong,
        `limit`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `markAllMentionsRead`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `userId`: kotlin.ULong
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `messageReadList`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong
    ): MessageReadListView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `messageReadStats`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong
    ): MessageReadStatsView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `paginateBack`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `page`: kotlin.ULong,
        `pageSize`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `paginateForward`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `page`: kotlin.ULong,
        `pageSize`: kotlin.ULong
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `qrcodeGenerate`(
        `qrType`: kotlin.String,
        `payload`: kotlin.String,
        `expireSeconds`: kotlin.ULong?
    ): QrCodeGenerateView
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `recallMessageBlocking`(
        `serverMessageId`: kotlin.ULong,
        `channelId`: kotlin.ULong
    ): kotlin.Boolean
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `removeChannelMember`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `memberUid`: kotlin.ULong
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `resolveLocalMessageIdByServerMessageId`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `serverMessageId`: kotlin.ULong
    ): kotlin.ULong?
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `sendMessageBlocking`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `fromUid`: kotlin.ULong,
        `content`: kotlin.String
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `setChannelLowPriority`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `enabled`: kotlin.Boolean
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `setChannelNotificationMode`(
        `channelId`: kotlin.ULong,
        `channelType`: kotlin.Int,
        `mode`: kotlin.Int
    )
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `setMessageRevoke`(
        `messageId`: kotlin.ULong,
        `revoked`: kotlin.Boolean,
        `revoker`: kotlin.ULong?
    )
    ...
    @Throws(PrivchatFfiException::class)
    override fun `startSupervisedSync`(`intervalSecs`: kotlin.ULong)
    ...
    @Throws(PrivchatFfiException::class, kotlin.coroutines.cancellation.CancellationException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `updateDevicePushState`(
        `deviceId`: kotlin.String,
        `apnsArmed`: kotlin.Boolean,
        `pushToken`: kotlin.String?
    ): DevicePushUpdateView
...
sealed class SdkEvent {
    ...
    data class ResumeSyncCompleted(
        ...
        val `channelFailures`: kotlin.ULong
    ) : SdkEvent() {
    ...
    data class ResumeSyncEscalated(
        ...
        val `channelType`: kotlin.Int? = null
    ) : SdkEvent() {
    ...
    data class SyncEntitiesApplied(
        ...
        val `applied`: kotlin.ULong,
        val `droppedDuplicates`: kotlin.ULong
    ) : SdkEvent() {
    ...
    data class OutboundQueueUpdated(
        ...
        val `queueIndex`: kotlin.ULong? = null
    ) : SdkEvent() {
