...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_cancel_message_media_download(void * ptr, int64_t messageId
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_create_local_attachment_placeholder(void * ptr, RustBuffer input, RustBuffer localMessageId
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_create_local_attachment_placeholder_typed(void * ptr, RustBuffer input, int64_t localMessageId, RustBuffer metadata
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_create_local_message(void * ptr, RustBuffer input
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_create_local_message_with_id(void * ptr, RustBuffer input, RustBuffer localMessageId
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_delete_channel_local(void * ptr, int64_t channelId
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_delete_message_local(void * ptr, int64_t messageId
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_detach_current_session(void * ptr
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_disconnect(void * ptr
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_download_attachment_into_cache(void * ptr, RustBuffer sourcePath, RustBuffer messageFileName, RustBuffer messageMimeType
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_download_attachment_into_dir(void * ptr, RustBuffer sourcePath, RustBuffer targetDir, RustBuffer messageFileName, RustBuffer messageMimeType
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_group_approval_handle_remote(void * ptr, RustBuffer requestId, int8_t approved, RustBuffer reason
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_qrcode_list(void * ptr, RustBuffer includeRevoked
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_qrcode_refresh(void * ptr, RustBuffer qrType, RustBuffer targetId
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_recache_user_avatar(void * ptr, int64_t userId, RustBuffer avatarUrl
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_resume_message_media_download(void * ptr, int64_t messageId
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_send_link_message(void * ptr, RustBuffer input
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_send_local_message_now(void * ptr, RustBuffer input
);
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_send_location_message(void * ptr, RustBuffer input
);
...
void uniffi_privchat_sdk_ffi_fn_method_privchatclient_submit_media_job_result(void * ptr, RustBuffer jobId, RustBuffer result, UniffiRustCallStatus *_Nonnull out_status
);
...
int64_t uniffi_privchat_sdk_ffi_fn_method_privchatclient_sync_state(void * ptr
);
...
int16_t uniffi_privchat_sdk_ffi_checksum_func_build_time(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_cancel_message_media_download(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_create_local_attachment_placeholder(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_create_local_attachment_placeholder_typed(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_create_local_message(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_create_local_message_with_id(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_delete_channel_local(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_delete_message_local(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_detach_current_session(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_disconnect(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_download_attachment_into_cache(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_download_attachment_into_dir(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_pause_message_media_download(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_prepare_avatar_image(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_recache_user_avatar(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_resume_message_media_download(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_send_link_message(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_send_local_message_now(void
    
);
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_send_location_message(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_set_channel_hidden_local(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_submit_media_job_result(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_sync_state(void
...
int16_t uniffi_privchat_sdk_ffi_checksum_method_privchatclient_wipe_current_user_full(void
