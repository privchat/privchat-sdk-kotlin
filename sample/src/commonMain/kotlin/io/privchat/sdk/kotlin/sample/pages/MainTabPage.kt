...
internal fun ViewContainer<*, *>.SessionsPage(init: io.privchat.sdk.kotlin.sample.pages.session.SessionsPage.() -> Unit = {}): io.privchat.sdk.kotlin.sample.pages.session.SessionsPage {
    val p = io.privchat.sdk.kotlin.sample.pages.session.SessionsPage()
    addChild(p, init)
    return p
}

internal fun ViewContainer<*, *>.FriendsPage(init: io.privchat.sdk.kotlin.sample.pages.friend.FriendsPage.() -> Unit = {}): io.privchat.sdk.kotlin.sample.pages.friend.FriendsPage {
    val p = io.privchat.sdk.kotlin.sample.pages.friend.FriendsPage()
    addChild(p, init)
    return p
}
